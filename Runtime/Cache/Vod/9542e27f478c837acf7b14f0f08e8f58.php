...
<script src="/Public/static/mediaplayer-5.9/jwplayer.js"></script>
    <link type="text/css" rel="stylesheet" href="/Public/Vod/css/style.css"/>
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <!---------------------------------------->
				...
				<div class="common_block_border">
                    <div class="common_block_title"><?php echo ($data["title"]); ?></div>               
                    <div class="detaildatetime">发布时间：<?php echo (date('Y-m-d H:i',$data["createtime"])); ?></div>
					<div style="padding: 0px 15px 10px 15px;display:none">                    
					  <?php if($data['price'] > 0 ): ?><button class="btn btn-primary" onClick="window.location.href='<?php echo U('cart?id='.$data['id']);?>'">购买后才可以阅读</button>
					  <?php else: endif; ?>
					</div>
					<div  style="width:100%;margin:0px 10px">
					  <div id="mediaplayer">
					    <video id="videotag" controls="controls" autoplay="autoplay">
                               <source src="<?php echo ($data["video"]); ?>" type="video/mp4"  autobuffer autoplay="autoplay" id="myVideo" webkit-playsinline="true" playsinline="true"/>
		                ...
		                $(function(){
						  ...
						  jwplayer("mediaplayer").setup({
						    width:640,
							height:480,
			                flashplayer: "/Public/static/mediaplayer-5.9/player.swf",
							file: "/1.mp4",
			                /*image: "/Public/static/mediaplayer-5.9/preview.jpg"
		                  });
						  */
						})
					...
					<div style="padding: 20px">
                       <?php echo hook('localComment', array('path'=>MODULE_NAME."/index/$data[id]", 'uid'=>get_uid()));?>
                    </div>
				</div>
				<!---------------------------------------->
            </div>
				  ...
				  <div class="common_block_border blog_position">
                    <div class="common_block_title">全站热门</div>
                     ...
                     <?php if(is_array($hotdata)): $i = 0; $__LIST__ = $hotdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="clearfix" style="position: relative">         
                         <div class="col-md-12">
                           <div>
                                <span class="rank_num"><?php echo ($num++); ?></span><h3 class="text-more" style="float:left"><a title="<?php echo ($vo['title']); ?>" href="<?php echo U('vod/Index/Detail',array('id'=>$vo['id']));?>"><?php echo (msubstr($vo["title"],0,10)); ?></a></h3>
                           </div>
                         </div>
                      </div>
					  <div class="col-md-12">

...
</style><?php echo C('DEFAULY_LAYOUT');?>
    <link type="text/css" rel="stylesheet" href="/Public/Live/css/style.css"/>
    <div class="container" style="min-height: 400px">
        <div class="row">
				   ...
				   <div class="common_block_border blog_position">
                    <div class="common_block_title" style="display:none">所有分类</div>
					 ...
					 <script type="text/javascript" src="/Public/Common/js/category.js"></script>
					  ...
					  <?php $tree_list = A("Common/Category"); $tree_list->ShowNoTitleCategory($tree,"/live/index/index"); ?>
					  </div>
					 </div>
            ...
            <div class="col-md-12">
				...
				<div class="common_block_border" style="min-height:500px;">

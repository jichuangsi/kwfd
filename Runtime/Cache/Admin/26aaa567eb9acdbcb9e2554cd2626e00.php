...
<body>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
			    <?php if($vo["isteacher"] == 1): ?><a href="<?php echo U('User/setTeacher?val=0&id='.$vo['uid']);?>" class="ajax-get">是</a>
				<?php else: ?>
				<a href="<?php echo U('User/setTeacher?val=1&id='.$vo['uid']);?>" class="ajax-get">否</a><?php endif; ?>
			</td>

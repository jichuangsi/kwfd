...
<style>
.detailcontent img{max-width:756px}
</style>
            ...
            <div class="col-md-9">
				...
				<div class="common_block_border">
					...
					<div style="padding: 20px">
                       <?php echo hook('localComment', array('path'=>MODULE_NAME."/index/$data[id]", 'uid'=>1));?>
                    </div>
				</div>
				<!---------------------------------------->
            </div>
				  ...
				  <div class="common_block_border blog_position">
                    <div class="common_block_title">全站热门</div>
                     ...
                     <?php if(is_array($hotdata)): $i = 0; $__LIST__ = $hotdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="clearfix" style="position: relative">         
                         <div class="col-md-12">
                           <div>
                                <span class="rank_num"><?php echo ($num++); ?></span><h3 class="text-more" style="float:left"><a title="<?php echo ($vo['title']); ?>" href="<?php echo U('News/Index/Detail',array('id'=>$vo['id']));?>"><?php echo (msubstr($vo["title"],0,10)); ?></a></h3>
                           </div>
                         </div>
                      </div>
					  <div class="col-md-12">

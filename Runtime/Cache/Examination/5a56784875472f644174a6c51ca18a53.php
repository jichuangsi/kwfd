				   ...
				   <div class="common_block_border blog_position">
                    <div class="common_block_title" style="display:none">所有分类</div>
					 ...
					 <script type="text/javascript" src="/Public/Common/js/category.js"></script>
					  ...
					  <?php $tree_list = A("Common/Category"); $tree_list->ShowNoTitleCategory($tree,"/Examination/Index/index"); ?>
					  </div>
					 </div>
				...
				<div class="common_block_border">
					...
					<?php if(is_array($contents)): $i = 0; $__LIST__ = $contents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="padding:0 20px" transitionparent>                     
					    <section  style="padding:0px 0px 10px 0px;">
						    <div>
                                <h4><a title='<?php echo ($vo["name"]); ?>' href="<?php echo U('Detail',array('id'=>$vo["id"]));?>"><?php echo ($vo["name"]); ?></a></h4>
                            </div>
                            <div style="position: relative;min-height:110px;height:auto!important;height:110px;">
							  <a title='<?php echo ($vo["name"]); ?>' href="<?php echo U('Detail',array('id'=>$vo["id"]));?>" target="_blank"><img src="<?php echo (get_cover($vo['image'],'path')); ?>" width="150" height="100" style="position: absolute" transition></a>
                              <div style="margin-left:160px">
                                   
                                   <div style="height:100px;overflow:hidden;">
                                        <span style="display:none">更新时间：<?php echo (date('Y-m-d H:i',$vo["updatedTime"])); ?></span>
                                        <p style="font-size:14px;color:#666666;line-height:25px">
										<a href="<?php echo U('Detail',array('id'=>$vo['id']));?>" style="color:#666666">
										  <?php echo (msubstr(strip_tags($vo["description"]),0,165,"utf-8",true)); ?>
										</a>
										</p>
                                   </div>
                              </div>
					...
					<div class="text-right" style="margin-right:20px">
                       <?php echo getPagination($totalPageCount,8);?>
                    </div>
				</div>
				<!---------------------------------------->
            </div>
				   ...
				   <div class="common_block_border blog_position">
                    <div class="common_block_title">全站热门</div>
                     ...
                     <?php if(is_array($hotdata)): $i = 0; $__LIST__ = $hotdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="clearfix" style="position: relative">         
                         <div class="col-md-12">
                           <div>
                                <span class="rank_num"><?php echo ($num++); ?></span><h3 class="text-more" style="float:left"><a title="<?php echo ($vo['name']); ?>" href="<?php echo U('Detail',array('id'=>$vo['id']));?>"><?php echo (msubstr($vo["name"],0,10)); ?></a></h3>
                           </div>
                         </div>
                      </div>
					  <div class="col-md-12">

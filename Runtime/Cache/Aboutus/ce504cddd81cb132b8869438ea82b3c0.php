...
<div id="main-container" class="container">
    ...
    <link type="text/css" rel="stylesheet" href="/Public/Aboutus/css/style.css"/>
    <div class="container" style="min-height: 400px">
        <div class="row">
		    <div class="col-md-2">
                <!---------------------------------------->
				   <div class="common_block_border blog_position">
				     <div class="common_block_title" style="display:none">导航</div>
					 <div class="category hidden-xs">
					 <link type="text/css" rel="stylesheet" href="/Public/Common/css/category.css"/>
					 <script type="text/javascript" src="/Public/Common/js/category.js"></script>
					  <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="clearfix" style="position: relative">         
                         <div class="col-md-12">
                           <div>
                              <a title="<?php echo ($vo['title']); ?>" href="<?php echo U('Detail',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a>
                           </div>
                         </div>
                      </div>
					  <div class="col-md-12">
					 ...
					 <div class="container visible-xs">
					   <div class="row">
					     <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-xs-4"><a title="<?php echo ($vo['title']); ?>" class="btn   <?php if(I('id') == $vo['id'] ): ?>btn-primary<?php else: ?> btn-default<?php endif; ?>" style="margin-top:10px" href="<?php echo U('Detail',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
					   </div>
					 </div>

...
.rmb-product-price{;border:0px solid #ff0000;margin:0px;padding:0px}
...
.rmb-product-price{;border:0px solid #ff0000;margin:0px;padding:0px}
    ...
    <link type="text/css" rel="stylesheet" href="/Public/Wenku/css/style.css"/>
        ...
        <div class="row">
				   ...
				   <div class="common_block_border blog_position">
                    <div class="common_block_title" style="display:none">所有分类</div>
					 ...
					 <script type="text/javascript" src="/Public/Common/js/category.js"></script>
					  ...
					  <?php $tree_list = A("Common/Category"); $tree_list->ShowNoTitleCategory($tree,"/wenku/index/index"); ?>
					  </div>
					 </div>
            ...
            <div class="col-md-12">
				...
				<div class="common_block_border">
					...
					<ul>
					<?php if(is_array($contents)): $i = 0; $__LIST__ = $contents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="rmb-box">
                    
					      <div class="rmb-product-detail">
									<a href="<?php echo U('Detail',array('id'=>$vo["id"]));?>" target="_blank">
								...
								<div class="rmb-product-desc">
									...
									<div class="rmb-product-price">
									    <span>更新时间：<?php echo (date('Y-m-d H:i',$vo["changetime"])); ?></span>
									</div>
						       </div>

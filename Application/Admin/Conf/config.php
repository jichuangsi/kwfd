...
return array(
    ...
    'DOWNLOAD_UPLOAD' => array(
        ...
        'exts'     => 'jpg,gif,png,jpeg,zip,rar,tar,gz,7z,doc,docx,txt,xml,mp4,flv,wmv,avi,pdf', //允许上传的文件后缀
    ...
    'EDITOR_UPLOAD' => array(
		'mimes'    => '', //允许上传的文件MiMe类型
		'maxSize'  => 200*1024*1024, //上传的文件大小限制 (0-不做限制)
		'exts'     => 'jpg,gif,png,jpeg,mp3,mp4,swf,zip,rar,tar,gz,7z,doc,docx,xls,xlsx,ppt,pdf,pdf', //允许上传的文件后缀
		'autoSub'  => true, //自动子目录保存文件
		'subName'  => array('date', 'Y-m-d'), //子目录创建方式，[0]-函数名，[1]-参数，多个参数使用数组

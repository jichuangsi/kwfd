 ...
 * 
 */
class WenkuController extends AdminController
{
     ...
     * @param $sell_num
	 */
    public function add($id = 0, $title = '', $image = '', $file = '', $content = '', $categoryid = array(), $price=0,$status = '')
    {
	   $isEdit = $id ? 1 : 0;
	   if (IS_POST) 
	   {
	   ...
	   else 
	   {
			...
			//->keySingleFile('file', '文件')
			->keyFileCanEdit('file', '文件','只支持pdf格式')

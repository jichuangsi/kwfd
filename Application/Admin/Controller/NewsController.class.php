...
class NewsController extends AdminController
{
	...
	public function lists($page = 1, $r = 20)
    {
		...
		//->keyText('sort', '排序')
		->keyText('view', '浏览量')->keyCreateTime('createtime', '创建时间')->keyDoActionEdit($this->_model.'/add?id=###')
     ...
     * @param $sell_num
	 */
    public function add($id = 0, $title = '', $image = '', $content = '', $categoryid = array(), $status = '')
    {
	   $isEdit = $id ? 1 : 0;
	   if (IS_POST) 
	   {

INSERT INTO `onethink_config` (`name`, `type`, `title`, `group`, `extra`, `remark`, `create_time`, `update_time`, `status`, `value`, `sort`) VALUES ( 'MASTER_API_ACTIVITY', 0, '教育中台活动接口', 0, '', '教育中台活动URL', 1378898976, 1532097941, 1, 'http://www.jichuangsi.com/parentjournalism/getactivity.php?domainname=', 0);
